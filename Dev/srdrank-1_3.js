...
// TODO SCS - FIX THIS FOR THE NEW CLIQUE + RECENCY INFO -> WILL MOVE THE TEAM INFO SPLICES RIGHT BY 2 places (to 10 ... )
...
//TODO SCS -  CLIQUES OUTPUT FORMAT CHANGE CHANGES ALL THESE BY MOVING COUNT, then the TEAMINFO right by 2 (COUNT=10?)
...
//    .text(linegen); //team index 1 is ratings splice index 9
    ...
    genter.append('text').attr("class","rank")
              .attr("x",5).attr("y","2em").text(function(d){ return d[8];}); //TODO NOW d[10] ?
    genter.append("text").attr("class","purerank")
              .attr('x',5+5*em).attr("y","2em").text(function(d) { return "("+d[7]+")";}); //TODO NOW d[9]?
